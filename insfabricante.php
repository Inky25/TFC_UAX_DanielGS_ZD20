    ...
    <div class="container mt-5">
        <div class="card shadow p-4">
            ...
            <div class="alert alert-info" role="alert">
                ...
                $sql = "INSERT INTO fabricante (Nombre, Descripcion) VALUES ('".$Nombre."', '".$Descripcion."')";
                
                if ($connection->query($sql) === TRUE) {
                    echo "<p class='text-success fw-bold'>Inserción del fabricante <strong>$Nombre</strong> correcta.</p>";
                } else {
            ...
            <div class="text-center mt-3">
                <a href="fabricante.php" class="btn btn-primary">Añadir otro</a>
            </div>
        </div>
    </div>
            <div class="text-center mt-3">
